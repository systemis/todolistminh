    ...
    <div className="min-h-screen flex flex-col items-center">
      <div className="flex-1 lg:w-2/3 xl:w-2/5 w-full px-7">
        <div>
          ...
          <div className="min-h-screen flex flex-col items-center">
            <div className="flex flex-col items-center justify-center h-screen w-screen bg-purple-200 dark:bg-dark_veryDarkBlue">
              <div className="h-4/5 w-4/5 bg-white relative overflow-hidden rounded-lg">
                <div
                  id="signin"
                  className={`dark:bg-[#272a30] bg-white absolute top-0 left-0 h-full w-1/2 flex justify-center items-center transition-all duration-700 ease-in-out z-20 ${isAnimated ? 'translate-x-full opacity-0' : ''
                    }`}
                >
                  <SigninForm />
                </div>
                <div
                  id="signup"
                  className={`dark:bg-[#272a30] absolute top-0 left-0 h-full w-1/2 flex justify-center items-center transition-all duration-700 ease-in-out ${isAnimated
